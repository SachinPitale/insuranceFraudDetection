    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        ...
        try:
            ...
            for col in self.cols_with_missing_values:
                if col == 'police_report_available':
    ...
    def encode_categorical_columns(self, data):
        ...
        try:
            ...
            try:
                ...
                self.cols_to_drop = ['policy_csl', 'insured_education_level', 'incident_severity', 'insured_sex','property_damage', 'police_report_available']
